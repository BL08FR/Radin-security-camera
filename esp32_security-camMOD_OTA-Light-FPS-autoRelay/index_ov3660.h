 ...
 * To set default relay position search "input type="range" id="idrelay" min="0" max="2" value=" and change value"x" (0=off, 1=on, 2=auto)
 */
...
<html>
          ...
          <input type="checkbox" id="nav-toggle-cb" checked="checked">
            <nav id="menu">
              ...
              <div class="input-group" id="fps-group">
                <label for="maxFPSlabel">Max. FPS</label>
                <div class="range-min">1</div>
                <input type="range" id="idmaxFPS" min="1" max="30" value="25" class="default-action">
                <div class="range-max">30</div>
              </div>

              <div class="input-group" id="relay-group">
                <label for="relayrange">Relay</label>
                <div class="range-min">0</div>
                <input type="range" id="idrelay" min="0" max="2" value="0" class="default-action">
                <div class="range-max">1-Auto</div>
              </div>
  ...
  document.addEventListener('DOMContentLoaded', function (event) {
    ...
    const relayGroup = document.getElementById('relay-group')
    const maxFPSgroup = document.getElementById('fps-group')
